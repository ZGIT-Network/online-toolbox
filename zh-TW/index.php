...
<body class="mdui-theme-primary-blue-800">
  ...
  <div class="mdui-toolbar mdui-color-blue-800 mdui-shadow-8">
    ...
    <a href="/tools/" mdui-tooltip="{content: '語言'}"><i class="mdui-icon material-icons">language</i></a>
  </div>
</div><br>
        ...
        <div class="mdui-col-sm-4 mdui-col-md-3">
            <div class="mdui-card mdui-shadow-7">
                ...
                <div class="mdui-card-primary">
                    ...
                    <div class="mdui-card-primary-subtitle">ZGIT Network 是至遠光輝資訊技術的網路服務平臺</div>
                </div>
                <!-- 卡片内容 -->
            ...
            <div class="mdui-card mdui-shadow-7">
                ...
                <div class="mdui-card-content">
                    ...
                    &copy; 至遠光輝資訊技術 保留所有權利。<br>
                    GPL-3.0<br><br>
                    背景圖片來自網絡<!--PIXIV, 画师: <b>周憂</b>--><br>
                    本站使用了MDUI，基於MDUI設計語言編寫<br>
                    MDUI是開源項目，任何人均可使用</div>
                </div>
            </div><br>
        </div>
        <!-- 2 -->
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState === 4) {
                ...
                if (INFOres.code == 200) {
                    ...
                    document.getElementById("INFOres").innerHTML ='<div class="mdui-panel-item-header"><b>您的用戶端資訊</b></div>'+'<div class="mdui-panel-item-body">'+ '<p>您的IP：' + INFOres.data.ip + '<br>您所在地區：' + INFOres.data.location + '<br>您的電信運營商：' + INFOres.data.isp + '<br>您的作業系統：'+ INFOres.data.os +'<br>您的瀏覽器：' + INFOres.data.browser + '</p></div>';
                } else {
                }  
