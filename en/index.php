...
<meta charset="utf-8">
<title>ZGIT Online Toolbox</title>
...
<body class="mdui-theme-primary-blue-800">
  ...
  <div class="mdui-toolbar mdui-color-blue-800 mdui-shadow-8">
    ...
    <a href="/tools/" class="mdui-btn mdui-btn-icon" mdui-tooltip="{content: 'Zgit Online Toolbox'}">
    <i class="mdui-icon material-icons">business_center</i></a>
    <a href="/tools/" mdui-tooltip="{content: 'Language'}"><i class="mdui-icon material-icons">language</i></a>
  </div>
</div><br>
        ...
        <div class="mdui-col-sm-4 mdui-col-md-3">
            <div class="mdui-card mdui-shadow-7">
                ...
                <div class="mdui-card-primary">
                    ...
                    <div class="mdui-card-primary-subtitle">ZGIT Network It is the network service platform of Zhiyuan Guanghui information technology.</div>
                </div>
                <!-- 卡片内容 -->
            ...
            <div class="mdui-card mdui-shadow-7">
                ...
                <div class="mdui-card-content">
                    ...
                    Brilliant home page Version: Alpha 1.1<br><br>
                    Background picture from the Internet<!--PIXIV, 画师: <b>周憂</b>--><br>
                    This site uses mdui and is written based on mdui design language.<br>
                   Mdui is an open source project that anyone can use.</div>
                </div>
            </div><br>
        </div>
        <!-- 2 -->
