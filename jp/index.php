<!--
ZGIT-Networkオープンソースプロジェクト:GPL-3.0プロトコルに従い、誰も商業的に使用できません。
作成者メールアドレス:l13230507790@outlook.com

Githubアドレス:https://github.com/ZGIT-Network/online-toolbox
Giteeアドレス:https://gitee.com/yunmoan/online-toolbox
-->
<!DOCTYPE html>
...
body{
   background-color: #000;
	background-image: url(https://api.r10086.com/%E5%8A%A8%E6%BC%AB%E7%BB%BC%E5%90%882.php?);
...
<body class="mdui-theme-primary-blue-800">
  ...
  <div class="mdui-toolbar mdui-color-blue-800 mdui-shadow-8">
    ...
    <small>オンラインツールボックス</small>
    <div class="mdui-toolbar-spacer"></div>
    <a href="/tools/" class="mdui-btn mdui-btn-icon" mdui-tooltip="{content:'ZGITオンラインツールボックス'}">
    <i class="mdui-icon material-icons">business_center</i></a>
    <a href="/tools/" mdui-tooltip="{content: '言語'}"><i class="mdui-icon material-icons">language</i></a>
  </div>
</div><br>
        ...
        <div class="mdui-col-sm-4 mdui-col-md-3">
            <div class="mdui-card mdui-shadow-7">
                ...
                <div class="mdui-card-primary">
                    ...
                    <div class="mdui-card-primary-subtitle">ZGIT Networkは至遠光輝情報技術までのネットワークサービスプラットフォームです。</div>
                </div>
                <!-- 卡片内容 -->
            ...
            <div class="mdui-card mdui-shadow-7">
                ...
                <div class="mdui-card-content">
                    ...
                    &copy; 至遠光輝情報技術 すべての権利を保持。<br>
                    光輝ホームページ Version: Alpha 1.1<br><br>
                    背景画像はネットワークから<!--PIXIV, 画师: <b>周憂</b>--><br>
                    当駅はMDUIを使用して、MDUIに基づいて言語を設計して書きます<br>
                    MDUIはオープンソースプロジェクトで、誰でも利用できます</div>
                </div>
            </div><br>
        </div>
        <!-- 2 -->
